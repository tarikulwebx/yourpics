...
<!--==================== SHOW MODAL =====================-->
<!--=====================================================-->
<div class="modal fade single-image-show" id="imageShowModal" tabindex="-1" aria-labelledby="imageShowModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <div class="author d-flex align-items-center gap-2">
                    <img src="/assets/images/profile-pic.jpg" class="rounded-circle d-block" alt="" />
                    <div>
                ...
                <div class="container-fluid">
                    <div class="row gy-4 mb-5">
                        <div class="col-sm-12 col-xl-8 text-center">
                            <div class="bg-light">
                                <img src="/assets/images/gallery-images/image (6).jpg" class="img-fluid single-image"
                                    alt="" />
                            </div>
                        </div>
                        <div class="col-sm-12 col-xl-4">
                            <h4 class="mb-4">Image Caption Title</h4>
                            <div class="row">
                        ...
                        <div class="col-12">
                            <div class="image-tags d-flex flex-wrap gap-2">
                                ...
                                <a class="badge rounded-pill" href="#" role="button">Tag Two</a>
                                <a class="badge rounded-pill" href="#" role="button">Tag Three</a>
                                <a class="badge rounded-pill" href="#" role="button">Tag Four</a>
                                <a class="badge rounded-pill" href="#" role="button">Tag Five</a>
                                <a class="badge rounded-pill" href="#" role="button">Tag Six</a>
                                <a class="badge rounded-pill" href="#" role="button">Tag Seven</a>
                                <a class="badge rounded-pill" href="#" role="button">Tag Eight</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="gallery-section">
                        <div id="gallery-grid-related-images" class="gallery-grid-related-images row g-4">
                            <div class="col-sm-6 col-md-4 col-lg-3 grid-item">
                                <div class="img-card">
                                    <img class="img-fluid" src="/assets/images/gallery-images/image (1).jpg"
                                        alt="" />
                                    <div class="card-hover-content p-2 d-flex flex-column text-white show-modal"
                                        ...
                                        <div
                                            ...
                                            <div class="author d-flex align-items-center gap-2">
                                                ...
                                                <div>
                                                    <h6 class="mb-0 fw-semibold">
                                                        <a href="#" class="text-decoration-none">Tarikul
                                                            Islam</a>
                                                    </h6>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 grid-item">
                                <div class="img-card">
                                    <img class="img-fluid" src="/assets/images/gallery-images/image (13).jpg"
                                        alt="" />
                                    <div class="card-hover-content p-2 d-flex flex-column text-white show-modal"
                                        data-bs-toggle="modal">
                                        <div
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 grid-item">
                                <div class="img-card">
                                    <img class="img-fluid" src="/assets/images/gallery-images/image (3).jpg"
                                        alt="" />
                                    <div class="card-hover-content p-2 d-flex flex-column text-white show-modal"
                                        data-bs-toggle="modal">
                                        <div
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 grid-item">
                                <div class="img-card">
                                    <img class="img-fluid" src="/assets/images/gallery-images/image (4).jpg"
                                        alt="" />
                                    <div class="card-hover-content p-2 d-flex flex-column text-white show-modal"
                                        data-bs-toggle="modal">
                                        <div
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 grid-item">
                                <div class="img-card">
                                    <img class="img-fluid" src="/assets/images/gallery-images/image (5).jpg"
                                        alt="" />
                                    <div class="card-hover-content p-2 d-flex flex-column text-white show-modal"
                                        data-bs-toggle="modal">
                                        <div
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 grid-item">
                                <div class="img-card">
                                    <img class="img-fluid" src="/assets/images/gallery-images/image (6).jpg"
                                        alt="" />
                                    <div class="card-hover-content p-2 d-flex flex-column text-white show-modal"
                                        data-bs-toggle="modal">
                                        <div
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 grid-item">
                                <div class="img-card">
                                    <img class="img-fluid" src="/assets/images/gallery-images/image (7).jpg"
                                        alt="" />
                                    <div class="card-hover-content p-2 d-flex flex-column text-white show-modal"
                                        data-bs-toggle="modal">
                                        <div
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 grid-item">
                                <div class="img-card">
                                    <img class="img-fluid" src="/assets/images/gallery-images/image (8).jpg"
                                        alt="" />
                                    <div class="card-hover-content p-2 d-flex flex-column text-white show-modal"
                                        data-bs-toggle="modal">
                                        <div
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 grid-item">
                                <div class="img-card">
                                    <img class="img-fluid" src="/assets/images/gallery-images/image (9).jpg"
                                        alt="" />
                                    <div class="card-hover-content p-2 d-flex flex-column text-white show-modal"
                                        data-bs-toggle="modal">
                                        <div
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 grid-item">
                                <div class="img-card">
                                    <img class="img-fluid" src="/assets/images/gallery-images/image (10).jpg"
                                        alt="" />
                                    <div class="card-hover-content p-2 d-flex flex-column text-white show-modal"
                                        data-bs-toggle="modal">
                                        <div
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 grid-item">
                                <div class="img-card">
                                    <img class="img-fluid" src="/assets/images/gallery-images/image (11).jpg"
                                        alt="" />
                                    <div class="card-hover-content p-2 d-flex flex-column text-white show-modal"
                                        data-bs-toggle="modal">
                                        <div
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 grid-item">
                                <div class="img-card">
                                    <img class="img-fluid" src="/assets/images/gallery-images/image (12).jpg"
                                        alt="" />
                                    <div class="card-hover-content p-2 d-flex flex-column text-white show-modal"
                                        data-bs-toggle="modal">
                                        <div
