...
@section('content')
    <main class="pb-5">
        ...
        <section class="author-section">
            <!-- Head -->
            <div class="head-wrapper bg-light px-sm-2 py-5 mb-5">
                <div class="container-xl">
                    <div class="row gy-4">
                        <div class="col-sm-4 col-xl-3">
                            <img src="{{ $author->picture_url }}" class="img-fluid rounded-circle shadow" alt="" />
                        </div>
                        <div class="col-sm-8 col-xl-9">
                            ...
                            <div>@ <a href="mailto:{{ $author->email }}">{{ $author->email }}</a></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container-xl">
                    <nav class="mb-4">
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <button class="nav-link active fw-semibold" id="nav-uploads-tab" data-bs-toggle="tab"
                                data-bs-target="#nav-uploads" type="button" role="tab" aria-controls="nav-uploads"
                                aria-selected="true">
                                Uploads ({{ $upload_count }})
                            </button>
                            <button class="nav-link fw-semibold" id="nav-favs-tab" data-bs-toggle="tab"
                                data-bs-target="#nav-favs" type="button" role="tab" aria-controls="nav-favs"
                                aria-selected="false">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-uploads" role="tabpanel"
                            ...
                            <section id="gallery-section" class="gallery-section uploads">
                                ...
                                <div class="text-center mt-4 pt-2 d-flex align-items-center justify-content-between gap-3">
                                    ...
                                    <button id="loadMorePictureBtn"
                                        class="btn btn-outline-primary rounded-circle loadmore-btn shadow"
                                        data-paginate="2">
                        ...
                        <div class="tab-pane fade" id="nav-favs" role="tabpanel" aria-labelledby="nav-favs-tab"
                            tabindex="0">
                            ...
                            <section id="gallery-section" class="gallery-section favs-section">
                                ...
                                <div class="text-center mt-4 pt-2 d-flex align-items-center justify-content-between gap-3">
                                    <hr class="border border-primary border-1 opacity-25 w-100" />
                                    <button id="loadMoreFavPictureBtn"
                                        class="btn btn-outline-primary rounded-circle loadmore-btn shadow"
                                        data-paginate="2">
                                        <span class="d-block">Load</span>
                                        <span class="d-block">More</span>
